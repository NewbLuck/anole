...
pub extern fn stbtt_PackBegin(spc: [*c]stbtt_pack_context, pixels: [*c]u8, width: c_int, height: c_int, stride_in_bytes: c_int, padding: c_int, alloc_context: ?*c_void) c_int;
...
pub extern fn stbtt_FreeBitmap(bitmap: [*c]u8, userdata: ?*c_void) void;
...
pub extern fn stbtt_Rasterize(result: [*c]stbtt__bitmap, flatness_in_pixels: f32, vertices: [*c]stbtt_vertex, num_verts: c_int, scale_x: f32, scale_y: f32, shift_x: f32, shift_y: f32, x_off: c_int, y_off: c_int, invert: c_int, userdata: ?*c_void) void;
pub extern fn stbtt_FreeSDF(bitmap: [*c]u8, userdata: ?*c_void) void;
...
pub const STBTT_DEF = @compileError("unable to translate C expr: unexpected token .Keyword_extern"); // repos/stb_truetype.h:489:9
